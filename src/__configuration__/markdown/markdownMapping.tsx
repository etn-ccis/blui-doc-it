...
export const componentsMap = {
    ...
    h4: (props: TypographyProps): JSX.Element => <Typography paragraph variant={'subtitle1'} color={'primary'} {...props} />,
    h5: (props: TypographyProps): JSX.Element => <Typography paragraph variant={'body2'} color={'primary'} {...props} />,
    h6: (props: TypographyProps): JSX.Element => <Typography paragraph variant={'body2'} style={{ fontSize: '0.75rem' }} color={'primary'} {...props} />,
    a: (props: TypographyProps<'a'>): JSX.Element => {
        if (props.href && props.href.match(/^http/ig)) {
            return (
