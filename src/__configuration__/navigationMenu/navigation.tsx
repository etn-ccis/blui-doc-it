        ...
        pages: [
            {
                title: 'App Bars',
                url: '/appbar',
                component: <MarkdownPage hasToC title={'App Bars'} markdown={Docs.Patterns.AppBar} />,
            },
            {
                title: 'Empty States',
                url: '/empty-states',
                component: <MarkdownPage hasToC title={'Empty States'} markdown={Docs.Patterns.EmptyStates} />,
            },
            {
                title: 'Forms and Validation',
                url: '/forms',
                component: <MarkdownPage hasToC title={'Forms and Validation'} markdown={Docs.Patterns.Forms} />,
            },
            {
                title: 'Internationalization',
                url: '/internationalization',
                component: <MarkdownPage hasToC title={'Internationalization'} markdown={Docs.Patterns.I18N} />,
            },
            {
                title: 'Lists & Tables',
                url: '/lists',
                component: <MarkdownPage hasToC title={'Lists & Tables'} markdown={Docs.Patterns.Lists} />,
            },
            {
                title: 'Loading & Waiting',
                url: '/loading',
                component: <MarkdownPage hasToC title={'Loading & Waiting'} markdown={Docs.Patterns.Loading} />,
            },
            {
                title: 'Navigation',
                url: '/navigation',
                component: <MarkdownPage hasToC title={'Navigation'} markdown={Docs.Patterns.Navigation} />,
            },
            {
                title: 'Overlays',
                url: '/overlay',
                component: <MarkdownPage hasToC title={'Overlays'} markdown={Docs.Patterns.Overlays} />,
            },
            {
                title: 'Page Layout',
                url: '/layout',
                component: <MarkdownPage hasToC title={'Page Layout'} markdown={Docs.Patterns.Layout} />,
                hidden: true,
            },
            {
                title: 'Steppers',
                url: '/steppers',
                component: <MarkdownPage hasToC title={'Steppers'} markdown={Docs.Patterns.Steppers} />,
            },
            {
                title: 'User Authentication',
                url: '/user-auth',
                component: <MarkdownPage hasToC title={'User Authentication'} markdown={Docs.Patterns.UserAuth} />,
            },
            {
                title: 'Visualizations',
                url: '/visualizations',
                component: <MarkdownPage hasToC title={'Visualizations'} markdown={Docs.Patterns.Visualizations} />,
            },
        ],
    },
    {
