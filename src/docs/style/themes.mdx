...
Both themes inherit from Material Design's baseline theme and expand upon it with PX Blue specific styles. The major differences between PX Blue themes and the default Material theme are the color palettes and [typographies](/style/typography).
...
<div style={REGULAR_WIDTH_STYLE}>
    <ImageGrid images={[LightThemeExample]} regularWidth caption={'An example of an application using the light them.'} />
</div>
