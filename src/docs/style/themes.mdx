...
<ImageGrid images={[LightThemeImage, DarkThemeImage]} style={{marginBottom: 32}} caption={'PXBlue offers a light theme (default theme) and a dark theme (for low-light condition usage).'} />
