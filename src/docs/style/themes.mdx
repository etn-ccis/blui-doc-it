import { ImageGrid, DemoCard, MaterialDesignDescription, Divider } from '../../app/components';
...
<div style={REGULAR_WIDTH_STYLE}>
    <DemoCard
        ...
        react={`https://codesandbox.io/embed/github/pxblue/themes/tree/master/react/demos/theme`}
    />
</div>
