...
<div style={REGULAR_WIDTH_STYLE}>
    <ImageGrid
        images={[LightThemeExample]}
        regularWidth
        caption={'An example of an application using the light theme.'}
    />
</div>
...
<div style={REGULAR_WIDTH_STYLE}>
    <ImageGrid
        images={[DarkThemeExample]}
        regularWidth
        caption={'An example of an application using the dark theme.'}
    />
</div>
