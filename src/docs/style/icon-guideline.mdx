...
import IconButtonRegular from '../../app/assets/design-patterns/icons/icon-button-regular.svg';
import IconButtonDense from '../../app/assets/design-patterns/icons/icon-button-dense.svg';
