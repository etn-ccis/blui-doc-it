...
import ExampleOfIcon from '../../app/assets/styles/icon-guideline/example-of-icon.png';
import ExampleOfLogo from '../../app/assets/styles/icon-guideline/example-of-logo.png';
import ExampleOfPictogram from '../../app/assets/styles/icon-guideline/example-of-pictogram.png';
import IconButtonOnTable from '../../app/assets/styles/icon-guideline/icon-button-on-table.png';
import IconButtonOnTable2 from '../../app/assets/styles/icon-guideline/icon-button-on-table-2.png';
import AmbiguousIconToggleGroup from '../../app/assets/styles/icon-guideline/ambiguous-icon-toggle-group.png';
import AmbiguousIconToggleGroup2 from '../../app/assets/styles/icon-guideline/ambiguous-icon-toggle-group-2.png';
import IconButtonMicroInteraction from '../../app/assets/styles/icon-guideline/icon-button-micro-interaction.svg';
import IconButtonRegular from '../../app/assets/styles/icon-guideline/icon-button-regular.svg';
import IconButtonDense from '../../app/assets/styles/icon-guideline/icon-button-dense.svg';
import IconButtonAppBar from '../../app/assets/styles/icon-guideline/icon-button-app-bar.png';
import IconButtonList from '../../app/assets/styles/icon-guideline/icon-button-list.png';
import IconButtonTextField from '../../app/assets/styles/icon-guideline/icon-button-text-field.png';
import IconButtonQuestionMark from '../../app/assets/styles/icon-guideline/icon-button-question-mark.png';
import InactiveIconSuccess from '../../app/assets/styles/icon-guideline/inactive-icon-success.png';
import InactiveIconUserPref from '../../app/assets/styles/icon-guideline/inactive-icon-user-pref.png';
import InactiveIconVolume from '../../app/assets/styles/icon-guideline/inactive-icon-volume.png';
import InactiveIconHeroes from '../../app/assets/styles/icon-guideline/inactive-icon-heroes.png';
import InactiveIconMeaningless from '../../app/assets/styles/icon-guideline/inactive-icon-meaningless.png';
import ConfusedHamburger from '../../app/assets/styles/icon-guideline/confused-hamburger.png';
import ConfusedSettings from '../../app/assets/styles/icon-guideline/confused-settings.png';
import DeviceIcon1 from '../../app/assets/styles/icon-guideline/device-icon-1.png';
import DeviceIcon2 from '../../app/assets/styles/icon-guideline/device-icon-2.png';
import WarningTwoColorLight from '../../app/assets/styles/icon-guideline/warning-two-color-light.svg';
import WarningTwoColorDark from '../../app/assets/styles/icon-guideline/warning-two-color-dark.svg';
import FilledIcon from '../../app/assets/styles/icon-guideline/filled-icon.png';
import OutlinedIcon from '../../app/assets/styles/icon-guideline/outlined-icon.png';
import IconVariation from '../../app/assets/styles/icon-guideline/icon-variation.png';
import IconVariation2 from '../../app/assets/styles/icon-guideline/icon-variation-2.png';
import ProgressIcon1 from '../../app/assets/styles/icon-guideline/progress-icon-1.png';
import ProgressIcon2 from '../../app/assets/styles/icon-guideline/progress-icon-2.png';
import DesignTemplate from '../../app/assets/styles/icon-guideline/design-template.svg';
import DesignTemplateOutline from '../../app/assets/styles/icon-guideline/design-template-outline.svg';
import DesignTemplateFinished from '../../app/assets/styles/icon-guideline/design-template-finished.svg';
...
<ImageGrid
    ...
    caption={[
        ...
        `The minimum touch area size of an icon button is 40x40dp. Note that this is also the "ripple size".`,
    ]}
/>
...
We welcome icon suggestions. If you would like to request your icon design to be added to our icon repository or request us to design an icon for you, please [contact us](/community/contactus). The UX team will review your request and provide a recommendation within 48 hours for whether to introduce a new icon or use an existing icon instead.

If you are requesting us to add your icon design, please follow [the guideline for exporting SVG icons](https://github.com/brightlayer-ui/icons/blob/master/design/README.md). You shall also provide us (1) the icon author we can publicly attribute to, (2) a brief description of what the intended use is, and (3) if possible a picture of where it will live in the context of your application.
