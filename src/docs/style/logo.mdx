...
<ImageGrid
    images={[Favicon]}
    caption={[
        `Favicon needs to be recognizable at a size as small as 16×16 pixel.`,
...
<ImageGrid
    ...
    captionsUnderImages={[
        `A regular app logo.`,
        `For platforms using round app logo shapes, such as Android's adaptive icon and Amazon Alexa Skills, the Eaton logo in the badge is shrinked to remain visible.`,
