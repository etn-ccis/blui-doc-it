...
App logos are the primary way users identify an app or a product. Not only do they appear on users' app launcher screens, app logos are also present in app markets like App Store and Google Play, the company's product pages, browser tabs, emails, and the app itself. They serve a critical function in a product's identity.

Eaton product teams are recommended to follow the following app logo guidelines.
...
Below are some existing app logos used at Eaton. Copyright all rights reserved Eaton. **HELP, I want to emphasize that these logos are not licensed under BSD-3**
...
Developers should include multiple favicons for these different resolutions in the HTML head's meta tags to accommodate for different favicon usage.
