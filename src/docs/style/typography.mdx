...
PX Blue provides a type scale that includes a range of styles to support the needs of your application. All styles and fonts are available in the design library. As PX Blue continues to grow, additional font patterns will be added.<ImageGrid images={[TypeScaleImg]} gridImageProps={{ xs: 12, sm: 8, md: 8 }} />
<Divider fullScreen />
