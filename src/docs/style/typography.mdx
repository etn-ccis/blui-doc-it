...
<ImageGrid images={[ApplicationImg]} gridImageProps={{ xs: 12, sm: 8, md: 8 }} style={{marginTop: 48, marginBottom: 16}} />

1: Card layout using default PX Blue styles

2: Card layout using custom created styles

<ImageGrid images={[HeadlineOptionsImg]} gridImageProps={{ xs: 12, sm: 8, md: 8 }} style={{marginTop: 48, marginBottom: 16}} />
