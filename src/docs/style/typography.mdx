...
Brightlayer UI provides a type scale that includes a range of styles to support the needs of your application. All styles and fonts are available in the design library. See the [Angular](https://material.angular.io/guide/typography) and [React](https://mui.com/components/typography/) Material theming documentation for more details for how each framework handles typography.
