...
<ImageGrid images={[ApplicationImg]} style={{ marginTop: 48, marginBottom: 16 }} gridImageProps={{ sm: 12 }} />

1: Card layout using default PX Blue styles

2: Card layout using custom created styles

<ImageGrid images={[HeadlineOptionsImg]} style={{ marginTop: 48, marginBottom: 16 }} gridImageProps={{ sm: 12 }} />
