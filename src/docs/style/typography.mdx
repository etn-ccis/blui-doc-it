...
<ImageGrid
    ...
    caption={[
        'You can manipulate many different aspects of your typography to indicate hierarchy.',
        '1: Font size',
        '2: Font weight',
        '3: Font color',
        '4: Combined',
...
<ImageGrid
    ...
    caption={[
        '1: Do not rely solely on font weight changes to indicate an active state. Do not let auxiliary text (the circled numbers on the right) distract your user.',
...
<ImageGrid
    ...
    caption={[
        '1: Be careful when using status color for a large body of text, as they have decreased legibility compared to those with neutral colors.',
