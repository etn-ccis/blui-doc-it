...
import LargerApplicationImg from '../../app/assets/styles/typography/larger-application.png';
import ApplicationImg from '../../app/assets/styles/typography/application.png';
import HeadlineOptionsImg from '../../app/assets/styles/typography/headline-options.png';
