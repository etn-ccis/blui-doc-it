...
<ImageGrid images={[TypeScaleImg]} style={{ marginTop: 32 }} gridImageProps={{ sm: 12 }} />
<Divider />
...
<ImageGrid images={[LargerApplicationImg]} style={{ marginTop: 32 }} gridImageProps={{ sm: 12 }} />
...
<ImageGrid images={[ApplicationImg]} style={{ marginTop: 48, marginBottom: 16 }} gridImageProps={{ sm: 12 }} caption={
    <>
    <Typography variant={'caption'}>1: Card layout using default PX Blue styles</Typography>
    <br />
    <Typography variant={'caption'}>2: Card layout using custom created styles</Typography>
    </>
}/>

<ImageGrid images={[HeadlineOptionsImg]} style={{ marginTop: 48, marginBottom: 16 }} gridImageProps={{ sm: 12 }} caption={
    <>
    <Typography variant={'caption'}>1: Two line headline using default PX Blue styles</Typography>
    <br />
    <Typography variant={'caption'}>2: Two line headline using custom created styles</Typography>
    </>
}/>
