...
Illustrations are design elements that should only be used only for onboarding and [empty states](/patterns/empty-states). Do not use illustrations when you are supposed to use icons.
