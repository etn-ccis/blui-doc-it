...
The aspect ratio of your illustrations should be between 1:1 and 2:3. If you are designing exclusively for desktop applications (i.e., the illustration will never show up on mobile), you can go wider, but no more than 16:9.
...
Use the [PX Blue color palette](/style/color) for your primary colors. You should use some shade of blue in the foreground of your images (these can be colors from the Blue, Light Blue, or Branding Blue palettes).
