...
<React.Fragment>
    ...
    <MaterialDesignDescription
        ...
        url={`https://web.archive.org/web/20200215051934/https://designguidelines.withgoogle.com/ads-branding/assets/1hquKP2EcBlDaWyaLkoezqd8r9KPjRgnp/visual-guidelines-google-marketing-platform.pdf`}
