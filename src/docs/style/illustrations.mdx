...
/>
<ImageGrid images={[BackgroundShapeImage]} caption={'The illustration background can either be a confined shape (left) or span through the entire container (right).'} gridImageProps={{ sm: 12 }} />
