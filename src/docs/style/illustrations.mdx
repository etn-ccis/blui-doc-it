...
Animations can draw attention to important parts. When combined with instruction text, they can provide a very interactive onboarding experience. We recommend [Lottie](https://lottiefiles.com/) to export and implement your animation.
