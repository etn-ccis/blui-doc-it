...
This expanded version of the color palette contains colors to be used for marketing, product identity, [data visualization](/patterns/visualizations) (non-status), etc. Power Xpert Blue uses these colors as the palette for charting and graphing.
