...
This expanded version of the color palette contains colors to be used for marketing, product identity, [data visualization](/visualizations/foundations) (non-status), etc. Brightlayer UI uses these colors as the palette for charting and graphing.
