...
If you're already using the latest packages for `@pxblue`, migration will be smoother. For example, if you currently have `@pxblue/colors@3.0.1` installed in your project, you should now be using `@brightlayer-ui/colors@3.0.1` instead. Some packages will require additional steps when migrating, you can find here [Package Migration Instructions](/brightlayer-ui-package-migration) .
