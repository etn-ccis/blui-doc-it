...
import { contributors } from '../../__configuration__/contributors';
...
<ContributorsList contributors={currentMaintainers} />

## Contributors

People who has contributed their code, ideas, designs, blah blah blah, to the ol' glory.
