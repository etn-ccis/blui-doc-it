...
-   In **2020**, the team released an updated CLI for automatically starting new projects with PX Blue integration and began working on new multi-screen re-usable workflows. The team also won {/* <!-- markdown-link-check-disable --> */}[two awards](https://www.designinnovationglobal.com/design-thinking/articles/di-global-awards-winners){/* <!-- markdown-link-check-enable --> */}: Brand transformation and Enterprise Design Transformation.
