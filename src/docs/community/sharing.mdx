<!-- KEYWORDS: sharing innersource -->

# Sharing Code

One of the primary goals of Power Xpert Blue is to eliminate the need for teams to duplicate effort. If you have built something using Power Xpert Blue that you think would benefit other development teams, we would love to hear from you. Please [Contact us](/community/contactus) and we will make your code available to other Power Xpert Blue adopter teams. If you'd like to contribute directly to PX Blue, have a look at our [Contribution Guidelines](https://github.com/pxblue/.github/blob/master/CONTRIBUTING.md).
