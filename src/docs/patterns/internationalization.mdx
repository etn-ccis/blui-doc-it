...
-   Phone number
-   Names (given name first or last)
-   Address (street name first or country name first)
-   Date and time
...
Your users may register a new account or create a new contact for anyone around the globe. You should provide options for them to register with a local phone number.
