...
<React.Fragment>
    ...
    <DemoCard
        ...
        angular={`https://blui-angular-design-patterns.web.app/internationalization`}
        react={`https://blui-react-patterns.web.app/i18n`}
    />
</React.Fragment>
...
<ImageGrid
    ...
    regularWidth
    caption={[
        '1: A user interface in left-to-right language (English).',
        '2: The same user interface in right-to-left language (Arabic).',
    ]}
/>
<ImageGrid
