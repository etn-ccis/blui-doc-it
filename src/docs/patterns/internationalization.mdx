...
Language options are typically presented in the user preferences / settings section of an application. In the case where users do not require an account (such as a public-facing website), the language option is expected in the app bar or in the footer.
