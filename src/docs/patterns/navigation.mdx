...
<ImageGrid images={[NavigationPermanentImg]} caption={['Permananent drawer on desktop.']} regularWidth />
...
<React.Fragment>
    ...
    <ImageGrid
        ...
        caption={['A temporary content-overlay menu (#1) combined with a bottom tab navigation (#2) on mobile.']}
        regularWidth
    />
