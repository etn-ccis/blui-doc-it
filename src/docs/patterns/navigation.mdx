...
import HoverImg from '../../app/assets/design-patterns/navigation/hover.gif';
...
<ImageGrid images={[NavigationPermanentImg]} 
 caption={[
            'Permananent drawer on desktop.',
        ]}
        regularWidth />
...
<ImageGrid images={[NavigationRailImg]} 
caption={[
        'Condensed Rail on desktop.',
    ]}
    regularWidth 
/>
<ImageGrid images={[NavigationRailLabelsImg]} 
caption={[
        'Standard rail with labels on desktop.',
    ]}
    regularWidth 
/>
...
<React.Fragment>
    <ImageGrid
        ...
        caption={[
            ...
            '2. Displays the open state of the menu.',
        ]}
        regularWidth
    />
    <ImageGrid
...
<React.Fragment>
    <ImageGrid images={[NavigationTemporaryImg]}
    caption={
            'Opened temporary drawer with overlay.'
        } regularWidth />
    <Divider />
</React.Fragment>
...
Tab navigation uses a horizontal bar with buttons for each navigation location. These can appear at the top or bottom of your application. On desktop and tablet, you can combine tabs and a drawer as a way to navigate between sub-pages (e.g., you may have several sub-pages on your main settings page). On mobile you can also combine tabs and a drawer. However,it is recommended that tabs replace the drawer navigation on mobile.

<ImageGrid images={[NavigationTabsImg]}
caption={[
        'Tab navigation combined with a rail menu to show sub-pages within the Settings page.',
    ]}
     regularWidth 
/>
<ImageGrid images={[NavigationBottomImg]}
caption={[
        'Bottom tab navigation combined with Temporary Content Overlay menu on mobile.',
    ]}
     regularWidth 
/>
...
<ImageGrid images={[NestedItemImg]}
caption={
            'Open and closed nested navigation.'
        } regularWidth />
...
<ImageGrid images={[NavigationRailSpecsImg, NavigationRailLabeledImg, PanelSpecsImg, NestedItemStandardsImg, NavigationTabsSpecsImg]} regularWidth />
