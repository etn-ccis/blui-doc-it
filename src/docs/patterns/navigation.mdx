...
<DemoCard repository={'side-navigation'} angular={'https://pxblue-components.github.io/angular/?path=/story/components-drawer--with-full-config'} react />
...
<DemoCard repository={'icon-navigation'} angular={'https://pxblue-components.github.io/angular/?path=/story/components-drawer--within-a-drawer-layout'} react={'https://pxblue-components.github.io/react/?path=/story/components-drawer--in-drawer-layout'} />
