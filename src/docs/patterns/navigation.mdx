...
<DemoCard repository={'side-navigation'} angular react />
...
/>
<DemoCard repository={'icon-navigation'} angular react={'https://pxblue-components.github.io/react/?path=/story/components-drawer--in-drawer-layout'} />
