import { MaterialDesignDescription, Divider, TOC, ProgressIconCard } from '../../app/components';
import PxblueSmallAltIcon from '@brightlayer-ui/icons-mui/PxblueSmallAlt';
import LinkIcon from '@material-ui/icons/Link';

# Icons

Icons can be a great visual aid to enhance the usability of your application. However, if they are not designed carefully, icons can be misleading as well.
...
This guide talks specifically about the design of icons, which should not be confused with other glyphs, such as pictograms and logos. Icons symbolize common actions, objects, or ideas used to aid users. Pictograms are... Logos are... [This could be represented well with a 3-column image with captions]
...
WCAG 2.2 AA level requires that non-textual contents of the webpage must achieve a minimum color contrast of 3:1. However, yellow icons are used for warnings and often have a contrast ratio of less than 2:1. In this situation, using two colors can make these icons more legible.
