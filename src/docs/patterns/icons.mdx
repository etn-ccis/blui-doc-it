...
Before going down the path of defining new icons, make sure to check existing icon resources. In addition to [Material Design's official icon set](https://fonts.google.com/icons?icon.set=Material+Icons) and [BLUI icon set](/style/iconography), [materialdesignicons.com](https://materialdesignicons.com/) is a community-driven icon repository that follows Material Design's icon guidelines.
