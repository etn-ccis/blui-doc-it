...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/loading-states/skeletons-loader`}
    react={`https://blui-react-patterns.web.app/skeletons`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/loading-states/spinner-overlays`}
    react={`https://blui-react-patterns.web.app/spinner-overlays`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/loading-states/contextual-spinners`}
    react={`https://blui-react-patterns.web.app/contextual-spinner`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/loading-states/progress-bars`}
    react={`https://blui-react-patterns.web.app/progress-bar`}
    reactNative
/>

<DemoCard
    repository={'Indeterminate Progress Bar'}
    angular={`https://blui-angular-design-patterns.web.app/loading-states/progress-bar-indeterminate`}
    react={`https://blui-react-patterns.web.app/progress-bar-indeterminate`}
    reactNative
/>
