...
<ImageGrid
    ...
    caption={[
        ...
        '1: Wave, where a flash glides pass gray shapes.',
        '2: Pulsate, where the gray shades change their brightness periodically.',
    ]}
/>
...
-   [@material-ui/lab/Skeleton](https://material-ui.com/components/skeleton/#skeleton)
