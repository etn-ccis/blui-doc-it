...
The login screen should always present information on how to create an account and what to do if a user has forgotten their password — these buttons should trigger the Registration and Forgot Password (see below) workflows .
