...
<React.Fragment>
    <DemoCard repository={'login'} angular react={`https://codesandbox.io/s/github/brightlayer-ui/react-workflows/tree/master/login-workflow/example`} ionic reactNative />
    <Divider />
</React.Fragment>
...
<React.Fragment>
    <TOC
        anchors={[
            ...
            { title: 'Login', depth: 1 },
            { title: 'Forgot / Changing Password', depth: 1 },
