...
import DrawerDetails from '../../app/assets/design-patterns/account-details/drawer-do-and-dont.png';
import UserMenuContents from '../../app/assets/design-patterns/account-details/user-menu-contents.png';
import AvatarVariants from '../../app/assets/design-patterns/account-details/avatar-variants.png';
...
import Specs5 from '../../app/assets/design-patterns/account-details/spec-avatar.png';
...
<ImageGrid
    ...
    regularWidth
    caption={[
        `1. Place the top account-related actions at the bottom of the drawer.`,
        `2. Avoid overcrowding the drawer by including too many user actions.`,
    ]}
/>
...
<ImageGrid images={[Specs3, Specs1]} regularWidth />
