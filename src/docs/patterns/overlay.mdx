...
import SpecsMobileDialog1 from '../../app/assets/design-patterns/overlays/spec-dialog-mobile-1.png';
import SpecsMobileDialog2 from '../../app/assets/design-patterns/overlays/spec-dialog-mobile-2.png';
import SpecsDesktopDialog from '../../app/assets/design-patterns/overlays/spec-dialog-desktop-1.png';
...
Modal bottom sheets block interaction with the rest of the application. These typically contain a list of options or actions and are usually activated via an action button in the [app bar](/patterns/appbar).<MaterialDesignDescription
title={'Lists'}
url={'/patterns/lists'}
...
<ImageGrid regularWidth images={[SpecsMobileDialog1]} />
<ImageGrid regularWidth images={[SpecsMobileDialog2]} />

## Desktop

If certain dimensions are not specified, refer to the dimensions suggested in the mobile section above.

<ImageGrid regularWidth images={[SpecsDesktopDialog]} />
<Divider />
