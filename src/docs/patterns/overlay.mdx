...
<ImageGrid
    images={[DesktopDialog, DesktopDialogTask]}
    caption={
        'A modal dialog appears centered in the screen over a dark overlay. These can present information to the user, or prompt them to enter information.'
    }
/>
...
<React.Fragment>
    <ImageGrid
        ...
        caption={[
            '1. On mobile, the bottom sheet takes up the full width of the screen.',
            '2. On desktop, the bottom sheet be no more than 600px wide.',
        ]}
    />
    <DemoCard
