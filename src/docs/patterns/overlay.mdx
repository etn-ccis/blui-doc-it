...
<ImageGrid
    ...
    captionsUnderImages={[
        'DONT: Do not arrange button so that your users are more likely to click the destructive option.',
        'DONT: Do not leave important details in the body text / description. Put them in the dialog title instead.',
        'DONT: “Alert!” does not match with “Yes” or “No”. You must make dialog options match the question being asked.',
        'AVOID: Your message should be concise. Avoid using wordy languages like “are you sure you want to” or “execute delete operation”.',
