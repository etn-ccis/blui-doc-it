...
import DrawerDetails from '../../app/assets/design-patterns/account-menu/drawer-do-and-dont.png';
...
import Specs4 from '../../app/assets/design-patterns/account-menu/spec-drawer.png';
import Specs5 from '../../app/assets/design-patterns/account-menu/spec-avatar.png';
...
<ImageGrid
    ...
    caption={[
        ...
        `3. Avoid overcrowding the drawer by including too many user actions.`,
    ]}
/>
...
<ImageGrid images={[Specs5]} regularWidth />
