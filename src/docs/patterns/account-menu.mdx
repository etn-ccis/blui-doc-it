...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/account-menu/in-a-drawer`}
    react={`https://blui-react-patterns.web.app/in-a-drawer`}
/>
...
<React.Fragment>
    <DemoCard
        ...
        angular={`https://blui-angular-design-patterns.web.app/account-menu/in-an-app-bar`}
        react={`https://blui-react-patterns.web.app/in-an-app-bar`}
    />
    <MaterialDesignDescription
        title={'Bottom Sheet'}
