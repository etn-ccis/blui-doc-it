...
<ImageGrid
    ...
    caption={[
        `1. User avatar and basic information can be placed in the drawer header.`,
        `2. Place the top account-related actions at the bottom of the drawer.`,
    ]}
/>
...
<React.Fragment>
    <DemoCard
        ...
        angular={`https://stackblitz.com/github/pxblue/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Faccount-menu%2Fin-a-drawer%2Fmenu-in-a-drawer.component.html`}
        react={`https://codesandbox.io/s/github/pxblue/react-design-patterns/tree/master?file=/src/pages/account-menu/in-a-drawer/index.tsx&initialpath=in-a-drawer`}
    />
...
<React.Fragment>
    <DemoCard
        ...
        angular={`https://stackblitz.com/github/pxblue/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Faccount-menu%2Fin-an-app-bar%2Fin-an-app-bar.component.html`}
        react={`https://codesandbox.io/s/github/pxblue/react-design-patterns/tree/master?file=/src/pages/account-menu/in-an-app-bar/index.tsx&initialpath=in-an-app-bar`}
    />
    <MaterialDesignDescription
        title={'Bottom Sheet'}
...
<React.Fragment>
    <ImageGrid
        ...
        caption={`Avoid overcrowding the drawer and the user menu by including too many user actions.`}
    />
    <Divider />
</React.Fragment>
