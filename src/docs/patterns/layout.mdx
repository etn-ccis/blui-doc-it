...
Material-UI for React applications provides a built-in [layout](https://mui.com/layout/basics/) mechanism, based on CSS flexbox. It allows you to build layouts based on CSS Grids, standard flexbox CSS, or a combination. Some of the main benefits of this library are:
...
You can see examples of how to do various Grid layouts on the [Material UI](https://mui.com/layout/grid/) website.
