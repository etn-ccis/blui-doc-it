...
<ImageGrid images={[Image1, Image2]} style={{marginBottom: 32}}/>
...
The most common lists in PX Blue applications will present some graphical representation of types of status for the items on the list. This is achieved by using status/type icons (avatars) and sometimes a colored left (inset) border to indicate status. In this instance, the separator line between list elements should extend only to the edge of the text, not below the avatar.

## Lists with Actions

<ImageGrid images={[Image3, Image4, Image5]} style={{marginBottom: 32}}/>
...
<ImageGrid images={[Image6]} style={{marginBottom: 32}}/>
...
<ImageGrid images={[Image7, Image8]} style={{marginBottom: 32}} caption={''} />
