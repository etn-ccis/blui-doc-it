...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/pxblue/angular-design-patterns?file=src%2Fapp%2Fpages%2Flist%2Fdata-list%2Fdata-list.component.ts`}
...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/pxblue/angular-design-patterns?file=src%2Fapp%2Fpages%2Flist%2Fresponsive-table%2Fresponsive-table.component.ts`}
...
On desktop applications, you may use hover events to display applicable list actions. Hover list actions can save spaces, leaving more room for displaying static information.

<ImageGrid
    images={[HoverActionsImage]}
    caption={
        'Hover actions can save more room on a desktop application, and save your application from repeated columns of action buttons; but the nature of it prevents this pattern from being used over touch screen devices like mobile phones and tablets.'
    }
    regularWidth
/>
