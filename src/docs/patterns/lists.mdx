...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Fdata-list%2Fdata-list.component.ts`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/data-list/index.tsx&initialpath=/data-list`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Fstatus-list%2Fstatus-list.component.html`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/status-list/index.tsx&initialpath=/status-list`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Faction-list%2Faction-list.component.ts`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/action-list/index.tsx&initialpath=/action-list`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Finline-button-panel%2Finline-button-panel.component.html`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/action-list/action-list-button-panel/index.tsx&initialpath=/action-list-button-panel`}
    reactNative
/>
<DemoCard
    repository={'Global Action List In Panel Header'}
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Fin-panel-header%2Fin-panel-header.component.html`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/action-list/action-list-panel-header/index.tsx&initialpath=/action-list-panel-header`}
    reactNative
/>
...
<React.Fragment>
    ...
    <DemoCard
        ...
        angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Fsortable-list%2Fsortable-list.component.ts`}
        react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/sortable-list/index.tsx&initialpath=/sortable-list`}
        reactNative
    />
</React.Fragment>
...
<React.Fragment>
    ...
    <DemoCard
        ...
        angular={`https://stackblitz.com/github/pxblue/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Fmultiselect-list%2Fmultiselect-list.component.ts`}
...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Finline-actions%2Finline-actions.component.html`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/action-list/action-list-inline/index.tsx&initialpath=/action-list-inline`}
    reactNative
/>

<DemoCard
    repository={'Local Actions'}
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Finline-local-actions%2Finline-local-actions.component.html`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/action-list/action-list-local-actions/index.tsx&initialpath=/action-list-local-actions`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Ftree%2Ftree.component.html`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/tree-structure-list/index.tsx&initialpath=/tree-structure-list`}
    reactNative
/>
...
<MaterialDesignDescription
    ...
    url={`https://material.io/components/lists#specs`}
/>
<Divider />
...
-   Angular Material
    ...
    -   [Info List Item](https://brightlayer-ui-components.github.io/angular/?path=/info/components-info-list-item--readme)
    -   [List Item Tag](https://brightlayer-ui-components.github.io/angular/?path=/info/components-list-item-tag--readme)
...
-   Material UI
    -   [List](https://mui.com/api/list/)
    -   [List Item](https://mui.com/api/list-item/)
-   @brightlayer-ui/angular-components
    -   [Info List Item](https://brightlayer-ui-components.github.io/react/?path=/info/components-info-list-item--get-read-me-story)
    -   [List Item Tag](https://brightlayer-ui-components.github.io/react/?path=/info/components-list-item-tag--get-read-me-story)
