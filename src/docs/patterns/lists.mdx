...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/lists/data-list`}
    react={`https://blui-react-patterns.web.app/data-list`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/lists/status-list`}
    react={`https://blui-react-patterns.web.app/status-list`}
    reactNative
/>
...
Using [tags](/patterns/tags) is another way to display list item status. They typically appear at the very end of a list item.
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/lists/action-list`}
    react={`https://blui-react-patterns.web.app/status-list/action-list`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/lists/in-button-panel`}
    react={`https://blui-react-patterns.web.app/in-button-panel`}
    reactNative
/>
<DemoCard
    repository={'Global Action List In Panel Header'}
    angular={`https://blui-angular-design-patterns.web.app/lists/in-panel-header`}
    react={`https://blui-react-patterns.web.app/in-panel-header`}
    reactNative
/>
...
<React.Fragment>
    ...
    <DemoCard
        ...
        angular={`https://blui-angular-design-patterns.web.app/lists/sortable-list`}
        react={`https://blui-react-patterns.web.app/sortable-list`}
        reactNative
    />
</React.Fragment>
...
<React.Fragment>
    ...
    <DemoCard
        ...
        angular={`https://blui-angular-design-patterns.web.app/lists/multi-select-list`}
        react={`https://blui-react-patterns.web.app/multiselect-list`}
        reactNative
    />
</React.Fragment>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/lists/inline-actions`}
    react={`https://blui-react-patterns.web.app/inline-actions`}
    reactNative
/>

<DemoCard
    repository={'Local Actions'}
    angular={`https://blui-angular-design-patterns.web.app/lists/inline-local-actions`}
    react={`https://blui-react-patterns.web.app/with-local-actions`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/lists/tree-structure`}
    react={`https://blui-react-patterns.web.app/tree-structure`}
    reactNative
/>
