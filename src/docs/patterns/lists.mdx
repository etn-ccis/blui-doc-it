...
<ImageGrid
    ...
    regularWidth
    caption={
        'Whenever you have a list that may include both avatars and icons, make sure all the icons, with or without avatars, are center-aligned. Otherwise, all icons should be left-aligned.'
    }
/>
...
Lists emphasize individual items, while tables highlight a comparison between each data point. However, tables generally perform poorly on a mobile device. Do not structure the list as a table if your users don't examine the data "vertically".
