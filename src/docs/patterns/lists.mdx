...
import Spec6Image from '../../app/assets/design-patterns/lists/spec-6.png';
...
Lists are usually used inside a panel (mobile) or in a card (desktop).
...
-   Where [data visualization](/patterns/visualizations) can be more effective
-   Pages with more than 2 lists that user have to constantly go back and forth
...
<ImageGrid images={[Spec1Image, Spec2Image, Spec3Image, Spec4Image, Spec5Image, Spec6Image]} regularWidth />
