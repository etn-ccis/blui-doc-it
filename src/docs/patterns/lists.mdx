...
Lists and tables are frequently used throughout Brightlayer UI applications. They are intended to represent groups of similar logical items, such as a device, an alarm, or a setting. They can display data from simple name-value pairs up to complex timelines or device lists.
...
<ImageGrid
    ...
    caption={['1: A simple key-value list.', '2: A key-value list with icons and subtitle.']}
/>
<DemoCard
    ...
    ionic={`https://stackblitz.com/github/brightlayer-ui/ionic-design-patterns?file=src%2Fapp%2Fpages%2Fapp-bar%2Fsearch-bar%2Fsearch-bar.component.ts`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Fstatus-list%2Fstatus-list.component.ts`}
    ...
    ionic={`https://stackblitz.com/github/brightlayer-ui/ionic-design-patterns?file=src%2Fapp%2Fpages%2Flist%2Fstatus-list%2Fstatus-list.component.ts`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Fresponsive-table%2Fresponsive-table.component.ts`}
    react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/responsive-table/index.tsx&initialpath=/responsive-table`}
/>
...
<DemoCard
    ...
    ionic={`https://stackblitz.com/github/brightlayer-ui/ionic-design-patterns?file=src%2Fapp%2Fpages%2Flist%2Faction-list%2Faction-list.component.ts`}
    reactNative
/>
...
<React.Fragment>
    ...
    <DemoCard
        ...
        ionic={`https://stackblitz.com/github/brightlayer-ui/ionic-design-patterns?file=src%2Fapp%2Fpages%2Flist%2Fsortable-list%2Fsortable-list.component.ts`}
        reactNative
    />
</React.Fragment>
...
<ImageGrid
    ...
    caption={[
        ...
        '6: An inline toggle switch.',
        '7: An inline dropdown field.',
        '8: An inline radio button group.',
    ]}
/>
...
<React.Fragment>
    ...
    <DemoCard
        ...
        angular={`https://stackblitz.com/github/brightlayer-ui/angular-design-patterns/tree/master?file=src%2Fapp%2Fpages%2Flist%2Fmultiselect-list%2Fmultiselect-list.component.ts`}
        react={`https://codesandbox.io/s/github/brightlayer-ui/react-design-patterns/tree/master?file=/src/pages/lists/multiselect-list/index.tsx&initialpath=/multiselect-list`}
        ionic={`https://stackblitz.com/github/brightlayer-ui/ionic-design-patterns?file=src%2Fapp%2Fpages%2Flist%2Fmultiselect-list%2Fmultiselect-list.component.ts`}
        reactNative
    />
</React.Fragment>
...
<React.Fragment>
    <ImageGrid
        images={[Spec1Image, Spec2Image, Spec3Image, Spec4Image, Spec5Image, SpecTypographyImage]}
        regularWidth
    />
