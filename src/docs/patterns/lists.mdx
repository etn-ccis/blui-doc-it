...
<ImageGrid images={[Image2]} style={{marginBottom: 32}}/>

<DemoCard repository={'data-list'} angular react ionic reactNative float={'right'} />
...
<ImageGrid images={[Image3]} style={{marginBottom: 32}}/>

<DemoCard repository={'status-list'} angular react ionic reactNative float={'right'} />
...
<ImageGrid images={[Image1]} style={{marginBottom: 32}}/>
...
<ImageGrid images={[Image4]} style={{marginBottom: 32}}/>
