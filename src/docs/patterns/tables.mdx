...
<ImageGrid
    images={[TabularList]}
    captionsUnderImages={['Be careful when combining tables and lists together, as this diminishes the value of both.']}
...
For industrial applications, in many situations your users would be using a mobile app when they are out in the field. They are paying more attention to their surroundings, so keep the mobile app interaction minimal.
