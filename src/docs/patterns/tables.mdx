...
<ImageGrid
    ...
    caption={[
        `CAUTION: Be careful not to place too many columns to overflow the table. If a horizontal scroll is necessary, place a horizontal scroll bar between rows and the footer / pagination area.`,
    ]}
    regularWidth
/>
