...
import HomePagePreview from '../../app/assets/design-patterns/tables/home-page-preview.png';
import TableStackedAsList from '../../app/assets/design-patterns/tables/table-stacked-as-list.png';
...
> Add mobile example for inf scrolling. This reduces load per page

> Add mobile example for pagination

## Native Mobile Interactions

> left swipe for actions
...
(Should be a section in app bar)
On batch action, change app bar

-   infinite selection
-   limited selection
-   image 1: Select devices to continue
-   image 2: 3 out of 4 selected

> TODO: in list, add the sticky checkbox micro interaction
...
-   Alternating Grid
-   checked row color
-   Row height for regular cells and text field cells
