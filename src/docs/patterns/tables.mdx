...
<ImageGrid
    images={[ExpandedRowTooComplicated]}
    captionsUnderImages={[
        `DONT: Do not put too many complicated contents in an expanded row, as this will break the efficiency of a table. In this case, you should design a dedicated page for the content.`,
    ]}
