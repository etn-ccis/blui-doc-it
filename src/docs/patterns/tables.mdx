...
## Understand If Users Need A Table On Their Phone

We do not encourage tables on mobile platforms. Do researches and see what their tasks are. Do they need to view all the details or only a few actions are needed.

## Rendering them as lists

Try rendering it as a list, stacking up everything and only leave the essential parameters for the user to decide which one to click into to view details.

> An image of list stacking

> Click inside to edit stuff
