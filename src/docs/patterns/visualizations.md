...
> Highcharts is [licensed](http://shop.highsoft.com/highcharts/) on a per-developer basis. If you would like to use Highcharts in your application, you will need to work with the appropriate software vendors to make sure your product is properly licensed. In future, we plan to explore additional open-source charting dor inclusion in PX Blue.
