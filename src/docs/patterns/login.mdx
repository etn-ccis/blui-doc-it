...
<DemoCard repository={'login'} angular react ionic reactNative float={'right'}/>
...
<ImageGrid images={[LoginInactiveImage, LoginViewPasswordImage, LoginErrorImage]} caption={'During the login process, the input field can be inactive, displaying a visible password, or showing error messages.'} />
