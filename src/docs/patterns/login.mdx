...
<ImageGrid images={[Image1, Image2, Image3, Image4]} style={{marginBottom: 32}}/>

<DemoCard repository={'login'} angular react ionic reactNative style={{marginBottom: 32}} float={'right'}/>
