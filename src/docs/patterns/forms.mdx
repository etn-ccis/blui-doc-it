...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/forms-and-validation/sectioned-form`}
    react={`https://blui-react-patterns.web.app/in-a-sectioned-form`}
/>

<DemoCard
    repository={'Forms in a List'}
    angular={`https://blui-angular-design-patterns.web.app/forms-and-validation/in-a-list`}
    react={`https://blui-react-patterns.web.app/in-a-list`}
/>

<DemoCard
    repository={'Forms in a Table'}
    angular={`https://blui-angular-design-patterns.web.app/forms-and-validation/in-a-table`}
    react={`https://blui-react-patterns.web.app/in-a-table`}
/>
...
<DemoCard
    repository={'Password'}
    angular={`https://blui-angular-design-patterns.web.app/forms-and-validation/password`}
    react={`https://blui-react-patterns.web.app/password`}
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/forms-and-validation/phone-number-format`}
    react={`https://blui-react-patterns.web.app/phone-number-format`}
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/forms-and-validation/verify-on-submit`}
    react={`https://blui-react-patterns.web.app/verify-on-submit`}
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/forms-and-validation/fixed-length-passcode`}
    react={`https://blui-react-patterns.web.app/fixed-length-passcode`}
/>
