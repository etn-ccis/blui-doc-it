...
<ImageGrid images={[Image1, Image2, Image3]} style={{marginBottom: 32}}/>
...
## Password
<ImageGrid images={[Image4, Image5, Image6]} style={{marginBottom: 32}} caption={'A common application of form validation -- reset password.'} />

If you need to further regulate your user input, for example when the user is entering a new password for their account, you may provide further information that hints the conditions to make the input field valid.
