...
import SpecsImage from '../../app/assets/design-patterns/form-validation/specs.png';

# Form Validation Patterns

<ImageGrid images={[SummaryImage]} fullSize />
...
When you are doing something like email verification code, you can omit the submit button.
...
<ImageGrid images={[SpecsImage]} fullSize />
<Divider />
