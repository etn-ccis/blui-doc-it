...
There are not as many charting libraries available for React Native applications as there are for web apps.
Additionally, the feature-set of mobile charting libraries may not be as rich as their web counterparts.
Brightlayer UI recommends [Victory Native](https://formidable.com/open-source/victory/docs/native/) as a viable library to consider when implementing graphs within a mobile app due to its relative popularity and clear documentation.
...
-   Charts & Graphs
    ...
    -   [@brightlayer-ui/highcharts](https://www.npmjs.com/package/@brightlayer-ui/highcharts)
    -   [ChartJS](https://www.chartjs.org/) (Open Source)
    -   [@brightlayer-ui/chartjs](https://www.npmjs.com/package/@brightlayer-ui/chartjs)

-   Maps
    -   [Mapbox](https://www.mapbox.com/) ([Pricing](https://www.mapbox.com/pricing/))
    -   [@brightlayer-ui/mapbox](https://www.npmjs.com/package/@brightlayer-ui/mapbox)
