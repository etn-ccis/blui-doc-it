...
import Image1 from '../../app/assets/design-patterns/collapsible-appbar/mobile-collapsible-appbar-expanded.png';
import Image2 from '../../app/assets/design-patterns/collapsible-appbar/mobile-collapsible-appbar-collapsed.png';
import Image3 from '../../app/assets/design-patterns/search-bar/mobile-search-bar.png';
import Image4 from '../../app/assets/design-patterns/search-bar/mobile-search-bar-search.png';
...
<DemoCard repository={'collapsible-appbar'} angular react ionic reactNative float={'right'}/>
...
<DemoCard repository={'search-bar'} angular react ionic reactNative float={'right'}/>
