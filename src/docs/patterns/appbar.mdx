...
<React.Fragment>
    ...
    <DemoCard
        ...
        ionic={
            'https://stackblitz.com/github/pxblue/ionic-design-patterns?file=src%2Fapp%2Fpages%2Fapp-bar%2Fcollapsible-app-bar%2Fcollapsible-app-bar.component.ts'
        }
        reactNative
    />
</React.Fragment>
...
If your search is not a global-level search, you can place your search input in different UI hierarchies to indicate the search context.
...
<React.Fragment>
    <ImageGrid
        ...
        caption={[
            ...
            '2: Page-wide search, usually placed in a secondary toolbar. This can be helpful when your entire page is composed of one single view, such as a single-page list view.',
