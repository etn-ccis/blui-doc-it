...
If your search is not a global-level search, you can relocate the search input to indicate the context of the search.

<React.Fragment>
    <ImageGrid
        images={[SiteSearch, PageSearch, ComponentSearch]}
        caption={[
            '1: Site-wide search, a.k.a. global search, is always placed in the primary app bar.',
            '2: Page-wide search, usually placed underneath the primary app bar. This can be helpful when your entire page is composed of one single view, such as a single-page list view.',
            '3: Component-wide search allows the user to search for contents within a certain component (e.g., cards, lists).',
        ]}
    />
    <Divider />
</React.Fragment>
