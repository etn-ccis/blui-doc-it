...
<ImageGrid
    ...
    caption={[
        `When a collapsible app bar (#1) collapses, it may choose to either hide the third line of text (#2), second line of text (#3), but the page title, or the first line of text, should never be hidden (#4).`,
    ]}
    regularWidth
/>
