...
<ImageGrid images={[Image1, Image2, <DemoCard repository={'collapsible-appbar'} angular react ionic reactNative/>]}/>
...
<ImageGrid images={[Image3, Image4, <DemoCard repository={'search-bar'} angular react ionic reactNative/>]}/>
