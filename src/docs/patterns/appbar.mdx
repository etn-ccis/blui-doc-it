...
<React.Fragment>
    ...
    <DemoCard
        ...
        angular={`https://pxblue-components.github.io/angular/?path=/story/components-app-bar--with-full-config`}
        react={`https://pxblue-components.github.io/react/?path=/story/components-app-bar--with-full-config`}
    />
</React.Fragment>
