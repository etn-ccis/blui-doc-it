...
<ImageGrid images={[Image1, Image2]} caption={'A collapsible app bar shrinks and gets pinned to the top when the page is scrolled.'} />
...
<ImageGrid images={[Image3, Image4]} caption={'When the search icon is clicked, a white search bar will slide in and cover the default tool bar. '} />
