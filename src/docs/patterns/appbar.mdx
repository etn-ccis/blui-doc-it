...
<ImageGrid images={[Image1, Image2]} style={{marginBottom: 32}} caption={'A Collapsible App Bar will pin at the top as the user swipes up.'} />
...
<ImageGrid images={[Image3, Image4]} style={{marginBottom: 32}} caption={'When the search icon is clicked, a white Search Bar will slide in and cover the default tool bar. '} />
