...
import TransparentVariants from '../../app/assets/design-patterns/app-bar/transparent-app-bar-variants.png';
import TransparentUsage from '../../app/assets/design-patterns/app-bar/transparent-app-bar-usage.jpg';
import TransparentOverlay from '../../app/assets/design-patterns/app-bar/transparent-app-bar-overlay.png';

{/* KEYWORDS: design pattern appbar search collapse collapsible extend prominent toolbar banner header transparent overlay */}
...
<React.Fragment>
    ...
    <TOC
        anchors={[
            ...
            { title: 'Style Variants', hash: '#style-variants' },
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/app-bar/dropdown-toolbar`}
    react={`https://blui-react-patterns.web.app/toolbar-menu`}
/>
...
<React.Fragment>
    ...
    <DemoCard
        ...
        angular={`https://blui-angular-design-patterns.web.app/app-bar/collapsible`}
        react={`https://blui-react-patterns.web.app/collapsible`}
    />
</React.Fragment>
...
We provide three style variants for both the Base Appbar and Extend Appbar: Blue, Default, and Transparent. You can choose among them based on the different project situations.

<ImageGrid regularWidth images={[TransparentVariants]} />

In some displays of 2D and 3D graphic objects or compact HMI application scenarios, when we want to provide users with a better immersive viewing experience, we can choose the Transparent appbar style.

<ImageGrid regularWidth images={[TransparentUsage]} />

The transparent variant defines two states, default and overlay, each corresponding to a different style. Generally, when the page content scrolls or layers overlap, the app bar transitions from the default to the overlay state.

<ImageGrid images={[TransparentOverlay]} />
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/app-bar/global-search`}
    react={`https://blui-react-patterns.web.app/search`}
    reactNative
/>

<DemoCard
    repository={'Page-Wide Search'}
    angular={`https://blui-angular-design-patterns.web.app/app-bar/page-wide-search`}
    react={`https://blui-react-patterns.web.app/page-wide-search`}
    reactNative
/>
...
<DemoCard
    ...
    angular={`https://blui-angular-design-patterns.web.app/app-bar/contextual`}
    react={`https://blui-react-patterns.web.app/contextual-action`}
/>
*/}
