...
For additional instructions, refer to [Material Design's design specs on "App bars: top"](https://material.io/components/app-bars-top#specs).
...
<ImageGrid images={[Specs2Image]} regularWidth />
<Divider />
