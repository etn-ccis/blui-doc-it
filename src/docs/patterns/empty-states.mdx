...
import Image3 from '../../app/assets/design-patterns/empty-states/mobile-empty-state-actions.png';
import Image4 from '../../app/assets/design-patterns/empty-states/mobile-empty-state-placeholder.png';
...
<ImageGrid images={[Image1, Image2]} style={{marginBottom: 32}} caption={'When awaiting data, use placeholder shapes for where the data will appear.'}/>
...
<ImageGrid images={[Image3, Image4]} style={{marginBottom: 32}}/>
