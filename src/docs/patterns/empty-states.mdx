...
-   How to get the data: What actions do they need to take to populate the data?

<ImageGrid
    images={[DontDistractImage, DoEncourageImage]}
    caption={
        'Do not display table headers or pagination when datasets are empty as they can be distracting to users. Instead, provide instructions to help your user out of the empty state situation.'
    }
/>
