...
/>
<DemoCard repository={'loading-states'} angular react={'https://codesandbox.io/s/github/pxblue/react-design-patterns/tree/master?file=/src/pages/loading-states/index.tsx&initialpath=loading-states'} ionic reactNative />
...
<DemoCard repository={'empty-states'} angular react={'https://pxblue-components.github.io/react/?path=/story/components-empty-state--with-full-config'} ionic reactNative />
