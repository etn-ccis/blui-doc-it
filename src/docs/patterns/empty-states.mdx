...
import Image1 from '../../app/assets/design-patterns/loading-states/mobile-loading-state-load.png';
import Image2 from '../../app/assets/design-patterns/loading-states/mobile-loading-state.png';
