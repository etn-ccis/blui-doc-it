...
<!-- KEYWORDS: design pattern empty state loading placeholder -->
...
<DemoCard repository={'empty-states'} angular={'https://pxblue-components.github.io/angular/?path=/story/components-empty-state--with-full-config'} react={'https://pxblue-components.github.io/react/?path=/story/components-empty-state--with-full-config'} ionic reactNative />
