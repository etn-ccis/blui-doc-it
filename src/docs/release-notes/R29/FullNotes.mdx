...
-   Updated react auth workflow package to componentize, exported screens individually to allow for better custom screen ordering and injection, supported React Router v6 and router customizability and support for the latest versions of i18next and react-i18next packages.
