...
-   Finished Re-architected of React Native auth workflow package to allow for greater control and flexibility from the application side.
...
-   @brightlayer-ui/react-native-auth-workflow v6.0.0 ([Changelog](https://www.npmjs.com/package/@brightlayer-ui/react-native-auth-workflow))
