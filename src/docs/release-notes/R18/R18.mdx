...
-   Added a [Mobile Stepper](https://brightlayer-ui-components.github.io/angular/?path=/info/components-mobile-stepper--readme) component for Angular
...
-   Reusable [Authentication Workflow](https://www.npmjs.com/package/@brightlayer-ui/angular-auth-workflow) for Angular.
