...
-   Released a new [Design Pattern Stickersheet](https://www.figma.com/community/file/926189711301522231) that will include many examples of all of our [Design Patterns](/patterns), starting with [forms](https://pxblue.github.io/patterns/forms), [side sheet](https://pxblue.github.io/patterns/overlay#sidebar) and [lists](https://pxblue.github.io/patterns/lists).
