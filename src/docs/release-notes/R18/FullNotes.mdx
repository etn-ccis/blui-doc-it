...
-   Released a new {/* <!-- markdown-link-check-disable --> */}[Design Pattern Sticker Sheet](https://www.figma.com/community/file/926189711301522231){/* <!-- markdown-link-check-enable --> */} that will include many examples of all of our [Design Patterns](/patterns), starting with [forms](/patterns/forms), [side sheet](/patterns/overlay) and [lists](/patterns/lists).
...
-   You can now use [templates](https://github.com/etn-ccis/blui-react-cli-templates) to kick-start your React projects with navigation and authentication
