...
We've moved! In order to make our documentation as accessible as possible, we've migrated our entire process over to GitHub. Our documentation can now be found at brightlayer-ui.github.io.
...
-   Bug fixes, including improving the consistency of Brightlayer UI themes between Angular and React
-   New icons added to [Brightlayer UI icons](/style/iconography)
