...
> These templates are available for [React](https://github.com/etn-ccis/blui-react/blob/master/packages/cli-templates/README.md#react--typescript--vite-templates) and [React-Native](https://github.com/etn-ccis/blui-react-native/blob/master/packages/cli-templates/README.md#react-native-cli-templates).
...
For detailed setup instructions, template options and usage guidance, refer to the following resources:

- [React documentation](https://github.com/etn-ccis/blui-react/blob/master/packages/cli-templates/README.md)
- [React Native documentation](https://github.com/etn-ccis/blui-react-native/blob/master/packages/cli-templates/README.md)
