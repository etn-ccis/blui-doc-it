...
The Brightlayer UI CLI works with all Brightlayer UI supported frameworks: Angular, React, and React Native. For React and React Native projects, you will have the option to create your project in TypeScript or JavaScript.
