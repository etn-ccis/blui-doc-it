...
> These templates are available for [Angular](https://github.com/pxblue/angular-cli-templates/blob/dev/README.md#angular-cli-templates), [React](https://github.com/pxblue/react-cli-templates/blob/dev/README.md#react-cli-templates), and [React-Native](https://github.com/pxblue/react-native-cli-templates/blob/dev/README.md#react-native-cli-templates). Ionic templates will be coming soon (Check our [Roadmap](/roadmap))!
