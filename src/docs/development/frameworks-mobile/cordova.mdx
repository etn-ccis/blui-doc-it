...
{/* KEYWORDS: apache cordova mobile hybrid framework guide tutorial  */}
...
> To bring in Material Design components and Brightlayer UI themes to your application, follow our Getting Started Guides for [Angular](/development/frameworks-web/angular) or [React](/development/frameworks-web/react).
