...
For detailed usage instructions, refer to the [Brightlayer UI React Native Templates documentation](https://github.com/etn-ccis/blui-react-native/blob/dev/packages/blui-react-native-cli-templates/README.md).
