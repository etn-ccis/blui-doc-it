...
> If you are an Eaton employee, please get on Eaton's network and [view our additional instructions for configure your proxy settings](https://eaton.sharepoint.com/sites/ERG_Human-CenteredDesign/SitePages/IT-Restrictions-in-adopting-Power-Xpert-Blue-to-your-project.aspx).
