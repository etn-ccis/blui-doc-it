...
-   [Android Studio](https://developer.android.com/studio/) (required for building for Android) — for Eaton machine setup, refer to the [Setting up certificate and proxy for React Native](https://eaton-corp.atlassian.net/wiki/spaces/GUILDS/pages/743443006/Setting+up+certificate+and+proxy+for+React+Native) guide
