...
> **NOTE:** If your application uses overlay components, you will also need to add the theme class to the [global overlay container](https://material.angular.io/guide/theming).
