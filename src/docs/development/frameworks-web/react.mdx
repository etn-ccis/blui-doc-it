...
For detailed usage instructions, refer to the [Brightlayer UI React Templates documentation](https://github.com/etn-ccis/blui-react/blob/master/packages/cli-templates/README.md).
