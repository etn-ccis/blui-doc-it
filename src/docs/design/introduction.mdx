...
In addition to these guidelines, we also provide a [Figma](https://www.figma.com/) library that gives you access to pre-built styles and assets that you can drag and drop to build designs for your applications. [Contact us](/community/contactus) to request access to this library. A future release of PX Blue will include an easy-to-use plugin that you can include in your Figma projects that can be updated to keep you up-to-date with the latest updates.
...
Interfaces greater than seven inches in width should be treated as a tablet device. As with phonde devices, font styles and layouts should be consistent across devices in this class. However, you may find it appropriate to have some differences between phone and tablet devices because of the difference in screen real estate.
<!--image-->
