...
Low contrast makes it difficult for all users to view your product, especially for individuals with visual impairments. You can test your contrast ratios using free [online tools](https://webaim.org/resources/contrastchecker/) and {/* <!-- markdown-link-check-disable --> */}[Figma plugins](https://www.figma.com/community/plugin/732603254453395948/Stark){/* <!-- markdown-link-check-enable --> */}.
