...
In addition to these guidelines, we also provide an easy-to-use plugin that you can include in your Figma projects to keep you up-to-date with the latest changes and improvements -- see [Environment Setup for Designers](/design/environment) for more information.
