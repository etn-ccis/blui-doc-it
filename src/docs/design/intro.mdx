...
PX Blue has design guidelines that serve as the foundation for the design system. These are intentional design choices we made to shape the PX Blue brand — what PX Blue applications should look like and how users should interact with them.
