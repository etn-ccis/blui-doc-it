...
In addition to these guidelines, we also provide a [Figma](https://www.figma.com/) library that gives you access to pre-built styles and assets that you can drag and drop to build designs for your applications. [Contact us](/community/contactus) to request access to this library. A future release of PX Blue will include an easy-to-use plugin that you can include in your Figma projects to keep you up-to-date with the latest changes and improvements.
