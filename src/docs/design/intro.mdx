...
We currently actively host and maintain our design assets via Figma. Figma is a powerful prototyping tool that facilitates team collaborations and design assets sharing. It works on both browsers and, if you prefer, a desktop app (Mac and PC). You may [sign up here](https://www.figma.com/).
...
In addition to these guidelines, we also provide [an easy-to-use plugin](https://www.figma.com/community/file/852558784352181868) that you can include in your Figma projects to keep you up-to-date with the latest changes and improvements. You are encouraged to duplicate this file to your own draft space and build your project on top of it.
