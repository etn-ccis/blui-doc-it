...
Many components have variations, like outlined vs. filled vs. transparency-based, flat vs elevated.
...
PX Blue [uses Open Sans and Noto Sans](/style/typography) for all its applications. We do allow you to change font weight and font size sporatically to display a better information hierarchy, but we strongly discourage you using fonts other than Open Sans and Noto Sans, especially Serif fonts.

### Consistency

We allow you to customize your UI and make design decisions, but you shall make sure your local design system is being carried through consistently. Once you pick a style, you should stick to it, instead of changing it every page.

### Design Traditions

Something are just design traditions. Everyone does that.
