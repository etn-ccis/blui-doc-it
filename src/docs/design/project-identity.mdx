...
PX Blue provides a foundation for designing and developing applications in a way that makes them feel like they are a part of the same brand. However, the purpose of PX Blue is not to make every application look the same.

As PX Blue serves as a design system for a wide range of applications, some projects might demand unique design or branding elements to better suit their audience. There is a balance that you must strike between maintaining consistency between applications and establishing a unique brand for each product. PX Blue provides some of the basic elements and patterns to help you build consistency, leaving you more time to focus on what makes your product unique.
...
PX Blue is not prescriptive — using PX Blue to be more efficient in practice shouldn’t mean restricting creativity in a project, or feeling limited on what might be improved.

just as we build on top of [Material Design](https://material.io) principles, you too can build on top of PX Blue principles to make your products better for your target audience. There are many gray areas and gaps in PX Blue where you are free to make changes and tweaks.
...
While establishing your local product identity, remember that PX Blue is here to help establish consistency. You do not want to customize so much that this is lost. Below, we go into details about some common areas of customization as well as some areas that should be avoided.
