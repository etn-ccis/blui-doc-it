...
PX Blue is not intended to stifle your creativity, but rather to enable it. PX Blue standardizes some of the basic elements of design in order to foster consistency between projects, which in turn allows you to spend more of your time and creativity on the parts of your project that make it unique.

Just as we build on top of [Material Design](https://material.io) principles, you too can build on top of PX Blue principles to make your products better for your target audience. There are many opportunities in PX Blue where you are free to make changes and tweaks.
