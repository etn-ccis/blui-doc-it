...
<BLCIconButton
    ...
    url={'https://www.figma.com/design/ZwJ3feoFnLiV3JNYqI7A3c/-Limited-Support--Brightlayer-UI-Component-Sticker-Sheet?node-id=33362-4509&m=dev'}
/>
<BLCIconButton
    icon={CommunityIcon}
...
<p style={{fontSize: '20px',fontWeight: '600',}}>Avoid comparing too many datasets in a single chart</p>
...
<p style={{fontSize: '20px',fontWeight: '600',}}>Choosing a baseline</p>
...
<p style={{fontSize: '20px',fontWeight: '600',}}>Using additional features to show variability</p>
...
<p style={{fontSize: '20px',fontWeight: '600',}}>Making sure the line chart is the right type for your data</p>
