...
import LinechartComponentImage from '../../app/assets/visualizations/linechart/line-chart-component.png';
import HorizontalLine from '../../app/assets/visualizations/linechart/horizontalline.png';
import MultipleLine from '../../app/assets/visualizations/linechart/multiplelines.png';
import CombinationChart from '../../app/assets/visualizations/linechart/combinationchart.png';
import Fewerlines from '../../app/assets/visualizations/linechart/fewerlines.png';
import Manylines from '../../app/assets/visualizations/linechart/manylines.png';
import Overstylingtabs from '../../app/assets/visualizations/linechart/over-styling-line-tabs.png';
import OverstylingAvoid from '../../app/assets/visualizations/linechart/over-styling-avoid.png';
import LargeAxisLabels from '../../app/assets/visualizations/linechart/large-axis-labels.png';
import NoZeroLineValue from '../../app/assets/visualizations/linechart/no-zero-line-value.png';
import DashedOpacityLine from '../../app/assets/visualizations/linechart/dashed-opacity-line.png';
import MultiStylingOptions from '../../app/assets/visualizations/linechart/multi-styling-options.png';
import UnevenAxMultiCat from '../../app/assets/visualizations/linechart/uneven-ax-multi-cat.png';
import UnevenAxIntervals from '../../app/assets/visualizations/linechart/uneven-ax-intervals.png';
...
import { COMMUNITY_LINE_CHARTS_URL } from '../../__configuration__/visualizations';
...
<BLCIconButton
    ...
    url={'https://www.figma.com/design/ZwJ3feoFnLiV3JNYqI7A3c/-Limited-Support--Brightlayer-UI-Component-Sticker-Sheet?node-id=33410-36560&m=dev'}
/>
<BLCIconButton
    icon={CommunityIcon}
    label={'View on BLUI Community Docs'}
    url={COMMUNITY_LINE_CHARTS_URL}
/>
...
<p style={{fontSize: '18px',fontWeight: '600',}}>Avoid comparing too many datasets in a single chart</p>
...
<ImageGrid
    ...
    captionsUnderImages={[
        ...
        'DONT:If you can’t avoid showing more than 8 datasets in the same chart, show the top results in color and group the remaining datasets in grey  (for edge cases only)'
    ]}
/>

<p style={{fontSize: '18px',fontWeight: '600',}}>Choosing a baseline</p>
...
<p style={{fontSize: '18px',fontWeight: '600',}}>Using additional features to show variability</p>
...
<p style={{fontSize: '18px',fontWeight: '600',}}>Making sure the line chart is the right type for your data</p>
