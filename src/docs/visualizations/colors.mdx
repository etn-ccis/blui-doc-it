import { ColorRowBlock, ImageGrid, CommunityBanner } from '../../app/components';
import DataSeriesLight from '../../app/assets/visualizations/colors/data-series-light.png';
import DataSeriesDark from '../../app/assets/visualizations/colors/data-series-dark.png';
import Consistency from '../../app/assets/visualizations/colors/consistency.png';
import Datarel1 from '../../app/assets/visualizations/colors/data-relationships-1.png';
import Datarel2 from '../../app/assets/visualizations/colors/data-relationships-2.png';
import Infohierarchy1 from '../../app/assets/visualizations/colors/infohierarchy1.png';
import Infohierarchy2 from '../../app/assets/visualizations/colors/infohierarchy2.png';
...
Our data viz components make use of the color tokens listed in the 
[Brightlayer UI sticker sheet](https://www.figma.com/design/Nydz8n8HBj6U3ZtULja3gD/%F0%9F%92%AB-Brightlayer-UI-Tokens-%2B-Components-(in-Material-Design-3)?node-id=0-1&node-type=canvas&t=B7pOWyjgMm1qqjda-0). 
This allows automatic switching between Light and Dark modes, and ensure your designs are always using standard Eaton palettes. We offer token 
support to 5 of the 16 Branding colors.

### Data Series

These are the hues from the Branding palette that we recommend using for data viz, for having the best 
contrast relationships and accessibility scores.
...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '24px', margin: '1rem 0' }}>
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
    <img
      src={DataSeriesLight}
      alt='Data Series palette on the light theme'
      style={{ width: '240px', height: 'auto', border: '1px solid #E0E0E0', borderRadius: '8px' }}
    />
    <span style={{ fontSize: '14px', fontWeight: 600, marginTop: '8px' }}>Light theme</span>
  </div>
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
    <img
      src={DataSeriesDark}
      alt='Data Series palette on the dark theme'
      style={{ width: '240px', height: 'auto', borderRadius: '8px' }}
    />
    <span style={{ fontSize: '14px', fontWeight: 600, marginTop: '8px' }}>Dark theme</span>
  </div>
</div>

### Axis and Grids

These are the color tokens used on ancillary elements of charts, such as axis, grids and 
reference lines.
...
These are the color tokens used on the Underlay component, which conveys additional data insights 
