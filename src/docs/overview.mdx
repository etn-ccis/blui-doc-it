...
Our mission is to empower world-class product development through high-quality & consistent digital resources.

### Our Vision

Product teams being empowered to collaboratively build innovative, world-class solutions that delight users and enable Eaton to provide real business value and faster delivery.

### Our Values

- Consistency over Conformity — We want products to be aligned and familiar to our users without limiting creativity.
- Learning and Growth — We are always learning and looking for ways to improve.
- Transparency & Honesty — We communicate openly, trust each other, and speak up.
- Feedback & Iteration — Nothing is final; we encourage and respond to feedback.
- Quality First — We aim for quality so that you can move quickly. We will take the time necessary to do it right.
- User Experience — We put our users first; user experience trumps other rules.
