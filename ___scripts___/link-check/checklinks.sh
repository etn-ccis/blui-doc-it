...
find src/docs/development/frameworks-mobile -maxdepth 1 -name \*.mdx -exec markdown-link-check {} -c ./___scripts___/link-check/config/depth-2.json \;

# Web Framework Links
echo "Checking Web Framework Links... "
find src/docs/development/frameworks-web -maxdepth 1 -name \*.mdx -exec markdown-link-check {} -c ./___scripts___/link-check/config/depth-2.json \;

# Get Started Links
echo "Checking Get Started Links... "
find src/docs/get-started -maxdepth 1 -name \*.mdx -exec markdown-link-check {} -c ./___scripts___/link-check/config/depth-1.json \;
