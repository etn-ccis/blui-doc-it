...
git remote add upstream git@github.com:etn-ccis/blui-doc-it.git
...
\`\`\`sh
origin  git@github.com:<your_github_username>/blui-doc-it.git (fetch)
origin  git@github.com:<your_github_username>/blui-doc-it.git (push)
upstream  git@github.com:etn-ccis/blui-doc-it.git (fetch)
upstream  git@github.com:etn-ccis/blui-doc-it.git (push)
\`\`\`
...
Check the [issues list](https://github.com/etn-ccis/blui-doc-it/issues) for anything you'd like to work on. If something exists, comment to claim it.

No issue yet? [Create one](https://github.com/etn-ccis/blui-doc-it/issues/new/choose). Issues help us track work and streamline the contribution process.
